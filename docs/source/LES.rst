...
.. note::
   ...
   Raw synthetic data used for development and optimization of this model can be obtained from:
   ...
   Sample code for interpolating and cross-sectioning raw files can be found in:
   ``./tools/interpolate_make_crosssect.py``
